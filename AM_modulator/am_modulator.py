...
class am_modulator(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "modulacion am", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("modulacion am")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 5000, 1, 0, 0)
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.blocks_throttle_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(2000000000, self.samp_rate)
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate)
        self.uhd_usrp_source_0.set_samp_rate(self.samp_rate)
        self.blocks_throttle_0_0.set_sample_rate(self.samp_rate)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(2000000000, self.samp_rate)
