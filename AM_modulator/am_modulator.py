...
class am_modulator(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.tunning = tunning = 102100000
        ...
        # Blocks
        ##################################################
        self._tunning_range = Range(70000000, 6000000000, 200000, 102100000, 200)
        self._tunning_win = RangeWidget(self._tunning_range, self.set_tunning, 'frequency', "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._tunning_win)
    ...
    def set_tunning(self, tunning):
        ...
        self.qtgui_sink_x_0.set_frequency_range(self.tunning, self.samp_rate)
